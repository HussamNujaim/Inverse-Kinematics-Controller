...
function [t, q, dq,error_pos,error_quat] = main4()
% close all
% clc
% clear
...
K = diag([40*[1 1 1], 50*[1 1 1]]);  %Gain Matrix 
...
for i=1:N
    ...
    %%%
    [theta,~,~] = trapezoidal(0, d_axesangle(4), 1.6, tf,t(i));
    axesangle=[d_axesangle(1:3); theta]';
    Rd = axang2rotm(axesangle);
    Rd = Ri*Rd;
